...
Route::get('/admin/contact/edit',[App\Http\Controllers\ContactController::class, 'edit'])->name('adminpage.contact.edit');
//promotion
...
Route::post('/admin/adminpromotion/add',[App\Http\Controllers\PromotionController::class, 'add'])->name('adminpage.promotion.add');
...
Route::post('/admin/adminblackground/add',[App\Http\Controllers\BlackgroundController::class, 'add'])->name('adminpage.blackground.add');
...
Route::post('/admin/content/add',[App\Http\Controllers\ContentController::class, 'add'])->name('adminpage.content.add');
